class OverseerrIntegration {
    ...
    async initialize() {
        ...
        try {
            ...
            const { plexToken, overseerrToken, overseerrSession, overseerrApiKey } = await chrome.storage.local.get([
                'plexToken', 
                'overseerrToken', 
                'overseerrSession',
                'overseerrApiKey'
            ...
            // Try Overseerr token if available
            if (overseerrToken && !this.token) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const result = {
                    ...
                    plexUrl: data.media?.plexUrl || null
                };
        ...
        try {
            ...
            if (response.ok) {
                ...
                const result = [{
                    ...
                    approved: isApproved,
                    plexUrl: mediaInfo?.plexUrl || null,
    ...
    extractAvailabilityFromSearchResult(movieResult) {
        ...
        const result = {
            ...
            plexUrl: movieResult.media?.plexUrl || null
        };
